...
export class Portfolio {
  ...
  projects = [
    ...
    },
    {
      ...
      description: 'An immersive and clean landing page for a cutting-edge cryptocurrency exchange, optimized for high conversion and responsive data tables.',
      descriptionRu: 'Лендинг для передовой криптовалютной биржи с адаптивными интерактивными таблицами данных.',
